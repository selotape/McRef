...
1. Run G-PhocS with comb enabled. Save data in *"comb-trace.tsv"* and *"trace.tsv"* files. Put files in an *experiment directory*
    * For explanation on G-PhoCS configuration and execution, see  [G-PhoCS Homepage](http://compgen.cshl.edu/GPhoCS/) and [G-PhoCS Manual](http://compgen.cshl.edu/GPhoCS/GPhoCS_Manual.pdf)
...
3. run `python3 ./run_model_compare.py [/path/to/experiment ...]`
4. ...
