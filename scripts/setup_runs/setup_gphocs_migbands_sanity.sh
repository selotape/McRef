...
#    popd
    ...
    old_control_file=/home/rvisbord/experiments/comb/M3.15.migAC_0_0/with_clade_and_mem_fix_without_assertions/${hyp}/${hyp}_control-file.ctl
    control_file=${sim}__${hyp}_control-file.ctl
    cp ${old_control_file} ./${control_file}
    sed -i -e "s/M3.15.migAC_0_4/${sim}/g" ${control_file}
